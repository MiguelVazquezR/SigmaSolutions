        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mb-12 max-w-[620px] lg:mb-20">
              ...
              >
                Nuestros servicios mas solicitados
              </h2>
              <p
          ...
          <div class="mx-4 w-full">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
                Algun párrafo referente a la sección de testimonios.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                <div class="ud-testimonial-meta">
                  <h4 class="text-sm font-semibold">Juan</h4>
                  <p class="text-xs text-[#969696]">Founder @ Jabil</p>
                </div>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                <div class="ud-testimonial-meta">
                  <h4 class="text-sm font-semibold">Mike Mcnamara</h4>
                  <p class="text-xs text-[#969696]">Founder @ Flex</p>
                </div>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                <div class="ud-testimonial-meta">
                  <h4 class="text-sm font-semibold">Elon Musk</h4>
                  <p class="text-xs text-[#969696]">Founder @ Tesla Motors</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
              ...
              >
                <img
                  src="assets/images/team/diego.png"
                  alt="image"
                  class="w-1/2 rounded-full grayscale"
                />
            ...
            <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
              ...
              >
                <img
                  ...
                  alt="image"
                  class="w-1/4 rounded-full grayscale"
                />
                <span class="absolute top-0 left-0 z-[-1]">
                  <svg
                    width="71"
              ...
              <div class="text-center">
                <h4 class="mb-2 text-lg font-medium text-dark">Angel Vázquez</h4>
                <p class="mb-5 text-sm font-medium text-body-color">
                  Ing. Electrónico
                </p>
                <div class="flex items-center justify-center">
            ...
            <div class="wow fadeInUp mb-10" data-wow-delay=".25s">
              ...
              >
                <img
                  ...
                  alt="image"
                  class="w-full rounded-full grayscale"
                />
                <span class="absolute top-0 left-0 z-[-1]">
                  <svg
                    width="71"
                ...
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p class="text-base text-body-color">
                      16 de Septiembre #3583, Hogares de Nuevo México - Zapopan, Jal.
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-[330px] max-w-full">
              ...
              <form method="post">
                <div class="mb-6">
                  ...
                  <input
                    type="text"
                    name="fullName"
                    placeholder="Jose Luis Rodríguez"
                ...
                <div class="mb-0">
                  <button
                    type="submit"
                    class="inline-flex items-center justify-center rounded-lg bg-primary py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-dark"
                  >
                    Enviar Mensaje
                  </button>
                </div>
